//declared the inventory for problem5
...
let c=require('./problem4.js');
OlderCars=[]
function problem5(inventory,c,OlderCars)
{
...
let OlderCarCount=problem5(inventory,c,OlderCars);
//I am not able to find that why OlderCars array gets printed
console.log(OlderCarCount.length);
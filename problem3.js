//declared the inventory for problem3
...
function problem3(inventory)
{
    ...
    {
       // SortModel.push(inventory[i]['car_model']);
       //this method sorts car model on the basis of  character's case so model needs to convert
       //to a certain case
       SortModel.push(inventory[i]['car_model'].toLocaleUpperCase());

    }
   return SortModel.sort();

};
let Model=problem3(inventory);
